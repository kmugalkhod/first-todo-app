...
3. Read the task file given in `/Users/kunal007/projects/first-todo-app/context/Stories/Task/0200-project-crud-and-data-model.md` (Section 2) and implement it fully against its *Requirement*, *Steps* and *Recommendation*.
...
| Field | Value |
|-------|-------|
| **Task File Path** | `context/Stories/Task/0200-project-crud-and-data-model.md` |
| **Task Title** | Project CRUD + Data Model |
| **Status** | `Done` |
| **Started** | 2026-08-03 |
