...
3. Read the task file given in `context/Stories/Task/0203-invitation-emails-and-acceptance.md` (Section 2) and implement it fully against its *Requirement*, *Steps* and *Recommendation*.
...
| Field | Value |
|-------|-------|
| **Task File Path** | `context/Stories/Task/0202-membership-and-invitation-data-model.md` |
| **Task Title** | Membership + Invitation Data Model |
| **Status** | `Done` |
| **Started** | 2026-08-03 |
